      ...
      >
        <motion.div variants={itemVariants} className="mb-8">
          <div className="relative inline-block">
            <div className="w-32 h-32 mx-auto rounded-full overflow-hidden border-4 border-blue-200 dark:border-blue-800 shadow-2xl z-20">
              <Image
                src={User.avatar}
            ...
            <motion.div
              className="absolute -inset-4 rounded-full bg-gradient-to-r from-blue-400 to-purple-500 opacity-30 blur-lg z-0"
              animate={{
                scale: [1, 1.1, 1],
                opacity: [0.3, 0.5, 0.3],
              }}
        ...
        >
          {[
            { icon: FaGithub, href: User.socialLinks.github, label: "GitHub" },
            {
              icon: FaLinkedin,
        ...
        >
          ...
          <motion.button
            className="px-8 py-4 bg-white dark:bg-gray-800 text-gray-800 dark:text-white rounded-full font-semibold border-2 border-blue-600 hover:bg-blue-50 dark:hover:bg-gray-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2 justify-center"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            <FaDownload size={16} />
