            ...
            {services.map((service, index) => (
              ...
              >
                <div className="relative h-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${service.bgGradient} opacity-0 group-hover:opacity-5 dark:group-hover:opacity-10 transition-opacity duration-500`}
                  ></div>

                  {/* Floating Border Effect */}
                  <motion.div
                    className={`absolute inset-0 rounded-3xl bg-gradient-to-r ${service.bgGradient} opacity-0 group-hover:opacity-20 dark:group-hover:opacity-30 blur-sm`}
                    initial={{ scale: 0.8 }}
                  ...
                  {/* Icon */}
                  <motion.div
                    className={`relative w-16 h-16 bg-gradient-to-r ${service.bgGradient} rounded-2xl flex items-center justify-center mb-6 shadow-lg ring-4 ring-white/50 dark:ring-gray-700/50`}
                  ...
                  {/* Animated Border */}
                  <motion.div
                    className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${service.bgGradient} rounded-b-3xl`}
                    initial={{ scaleX: 0 }}
                    whileHover={{ scaleX: 1 }}
                ...
                <div className="max-w-4xl mx-auto">
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      className="group relative w-full sm:w-auto px-8 py-4 border-2 border-white/40 text-white rounded-2xl font-semibold hover:bg-white/10 hover:border-white/60 transition-all duration-300 backdrop-blur-sm overflow-hidden"
                      whileHover={{
                        scale: 1.05,
                  ...
                  <motion.div
                    className="flex flex-wrap justify-center gap-6 sm:gap-8 text-base opacity-80"
                    initial={{ opacity: 0, y: 20 }}
                    animate={
                      isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
                    }
                  ...
                  >
                    {[
                      { icon: FaCheck, text: "Free Consultation" },
                      { icon: FaCheck, text: "Quick Response" },
                      { icon: FaCheck, text: "Professional Service" },
                    ].map((item, index) => (
                      <motion.div
                        key={index}
                      ...
                      >
                        <motion.div
                          className="w-5 h-5 bg-gradient-to-r from-green-400 to-blue-500 rounded-full flex items-center justify-center"
                          animate={{
                            scale: [1, 1.2, 1],
                            rotate: [0, 360, 0],
                          }}
